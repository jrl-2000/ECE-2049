...

{
    ...
    unsigned char your_name[14] = "Jonathan Lopez";
                                    // What happens when you change the array length?
    //less characters in the array
                                    // What should it be? Do you need null terminator /n ?
    //mine should be 13 +1 for the null terminator
    ...
    //Answers for these are on the lab write up
    ...
    Graphics_drawStringCentered(&g_sContext, "ECE2049-C21!", AUTO_STRING_LENGTH, 64, 70, TRANSPARENT_TEXT); //changing 64 to 84 and 70 to 80
    Graphics_drawStringCentered(&g_sContext, "Jonathan Lopez", AUTO_STRING_LENGTH, 64, 80, TRANSPARENT_TEXT);
